...
def train_logistic_model(clicks_and_buys):
...
if __name__ == '__main__':
    ...
    clicks_and_buys.ITEM_ID = clicks_and_buys.ITEM_ID.astype('int')
    ...
    print 'train on clicks_and_buys {}'.format(clicks_and_buys)
    model = train_logistic_model(clicks_and_buys)
    print model.model
